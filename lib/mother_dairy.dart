...
class Mother_Dairy extends StatefulWidget {
  @override
  State<Mother_Dairy> createState() => Mother_Dairy_Page();
}

class Mother_Dairy_Page extends State<Mother_Dairy> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/home-milk-1.png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
