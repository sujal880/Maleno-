...
class Amul_Ghee extends StatefulWidget {
  @override
  State<Amul_Ghee> createState() => Amul_Ghee_Page();
}

class Amul_Ghee_Page extends State<Amul_Ghee> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/40166277_2-amul-high-aroma-cow-ghee.webp',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
