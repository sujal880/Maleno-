...
class MilkShake extends StatefulWidget {
  @override
  State<MilkShake> createState() => MilkShake_Page();
}

class MilkShake_Page extends State<MilkShake> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('MilkShake')),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/badammilk.webp',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
