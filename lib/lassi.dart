...
class Lassi extends StatefulWidget {
  @override
  State<Lassi> createState() => Lassi_Page();
}

class Lassi_Page extends State<Lassi> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/amullassi.png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
