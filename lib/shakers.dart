...
class Shakers extends StatefulWidget {
  @override
  State<Shakers> createState() => Shakers_Page();
}

class Shakers_Page extends State<Shakers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('Shakers')),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/Amul-Kool-Mango-200ml.png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
