...
class Nestle_Ghee extends StatefulWidget {
  @override
  State<Nestle_Ghee> createState() => Nestle_Ghee_Page();
}

class Nestle_Ghee_Page extends State<Nestle_Ghee> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              Center(child: Image.asset('assets/images/ghee-041421-SG_770x533.jpg',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
