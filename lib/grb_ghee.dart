...
class GRB extends StatefulWidget {
  @override
  State<GRB> createState() => GRB_Page();
}

class GRB_Page extends State<GRB> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/Ghee.png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
