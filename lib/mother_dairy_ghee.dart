...
class MotherDairy_Ghee extends StatefulWidget {
  @override
  State<MotherDairy_Ghee> createState() => MotherDairy_Ghee_Page();
}

class MotherDairy_Ghee_Page extends State<MotherDairy_Ghee> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              Center(child: Image.asset('assets/images/ghee-pot1.webp',height: 300)),
              Padding(
