...
class DudhSagar_Ghee extends StatefulWidget {
  @override
  State<DudhSagar_Ghee> createState() => DudhSagar_Ghee_Page();
}

class DudhSagar_Ghee_Page extends State<DudhSagar_Ghee> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              Center(child: Image.asset('assets/images/depositphotos_183647416-stock-photo-glass-of-ghee-butter.jpg',height: 300)),
              Padding(
