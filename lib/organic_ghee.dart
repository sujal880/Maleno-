...
class Organic extends StatefulWidget {
  @override
  State<Organic> createState() => Organic_Page();
}

class Organic_Page extends State<Organic> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/20005456_4-organic-india-desi-ghee.webp',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
