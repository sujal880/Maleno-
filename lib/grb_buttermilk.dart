...
class GRB_Buttermilk extends StatefulWidget {
  @override
  State<GRB_Buttermilk> createState() => GRB_Buttermilk_Page();
}

class GRB_Buttermilk_Page extends State<GRB_Buttermilk> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('GRB Buttermilk')),
        actions: [
          IconButton(
