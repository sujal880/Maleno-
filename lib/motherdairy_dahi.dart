...
class MotherDairy_Dahi extends StatefulWidget {
  @override
  State<MotherDairy_Dahi> createState() => MotherDairy_Dahi_Page();
}

class MotherDairy_Dahi_Page extends State<MotherDairy_Dahi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('Motherdairy Dahi')),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/3508-2021-09-08 (1).png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
