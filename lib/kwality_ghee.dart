...
class Kwality_Ghee extends StatefulWidget {
  @override
  State<Kwality_Ghee> createState() => Kwality_Ghee_Page();
}

class Kwality_Ghee_Page extends State<Kwality_Ghee> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              Center(child: Image.asset('assets/images/166004200-spoon-of-clarified-butter-over-bowl-on-black-table-closeup.webp',height: 300)),
              Padding(
