...
class Kool extends StatefulWidget {
  @override
  State<Kool> createState() => Kool_Page();
}

class Kool_Page extends State<Kool> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('Kool KOKO')),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/0011531_amul-kool-koko-chocolate-bottle-200ml.png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
