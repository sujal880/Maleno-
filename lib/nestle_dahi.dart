...
class Nestle_Dahi extends StatefulWidget {
  @override
  State<Nestle_Dahi> createState() => Nestle_Dahi_Page();
}

class Nestle_Dahi_Page extends State<Nestle_Dahi> {
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/6f503437d13585283802925.png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
