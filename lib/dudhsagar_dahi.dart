...
class Dudhsagar_Dahi extends StatefulWidget {
  @override
  State<Dudhsagar_Dahi> createState() => Dudhsagar_Dahi_Page();
}

class Dudhsagar_Dahi_Page extends State<Dudhsagar_Dahi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('Dudhsagar Dahi')),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Stack(children: [
          Column(
            ...
            children: [
              SizedBox(height: 20),
              Center(child: Image.asset('assets/images/3508-2021-09-08.png',height: 300)),
              SizedBox(
                height: 20,
              ),
              Padding(
